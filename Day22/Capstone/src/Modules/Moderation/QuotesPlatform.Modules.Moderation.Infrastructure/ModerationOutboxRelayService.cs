...
/// <summary>
/// Claims pending ModerationDbContext.OutboxMessages rows, publishes them to
...
/// </summary>
public sealed class ModerationOutboxRelayService(
    IServiceScopeFactory scopeFactory,
    ServiceBusClient serviceBusClient,
    ILogger<ModerationOutboxRelayService> logger) : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        do
        {
            ...
            catch (Exception exception) when (exception is not OperationCanceledException)
            {
                ...
                logger.LogError(exception, "Moderation outbox relay tick failed; continuing after the poll interval");
            }
        }
    ...
    private async Task<List<OutboxMessage>> ClaimBatchAsync(ModerationDbContext db, CancellationToken cancellationToken)
    {
