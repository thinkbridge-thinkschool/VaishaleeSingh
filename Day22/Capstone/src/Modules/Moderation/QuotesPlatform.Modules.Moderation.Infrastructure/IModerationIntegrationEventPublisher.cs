...
/// <summary>
/// Moderation's own outbox port, and the reason it exists is worth stating.
///
...
/// </summary>
public interface IModerationIntegrationEventPublisher : IIntegrationEventPublisher
{
}
