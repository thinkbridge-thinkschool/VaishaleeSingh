...
/// <summary>
/// Claims pending PublishingDbContext.OutboxMessages rows, publishes them to
/// the shared "capstone.collection-events" topic, marks them Sent.
///
...
/// </summary>
public sealed class PublishingOutboxRelayService(
    IServiceScopeFactory scopeFactory,
    ServiceBusClient serviceBusClient,
    ILogger<PublishingOutboxRelayService> logger) : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        do
        {
            ...
            catch (Exception exception) when (exception is not OperationCanceledException)
            {
                ...
                logger.LogError(exception, "Publishing outbox relay tick failed; continuing after the poll interval");
            }
        }
    ...
    private async Task<List<OutboxMessage>> ClaimBatchAsync(PublishingDbContext db, CancellationToken cancellationToken)
    {
