...
/// <summary>
/// Claims pending CatalogDbContext.OutboxMessages rows, publishes them to the
...
/// </summary>
public sealed class CatalogOutboxRelayService(
    IServiceScopeFactory scopeFactory,
    ServiceBusClient serviceBusClient,
    ILogger<CatalogOutboxRelayService> logger) : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        do
        {
            ...
            catch (Exception exception) when (exception is not OperationCanceledException)
            {
                ...
                logger.LogError(exception, "Catalog outbox relay tick failed; continuing after the poll interval");
            }
        }
    ...
    private async Task<List<OutboxMessage>> ClaimBatchAsync(CatalogDbContext db, CancellationToken cancellationToken)
    {
